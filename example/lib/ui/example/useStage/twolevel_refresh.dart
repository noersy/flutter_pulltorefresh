      ...
      child: Scaffold(
        bottomNavigationBar: !_refreshController1.isTwoLevel
            ? BottomNavigationBar(
                ...
                items: [
                  BottomNavigationBarItem(icon: Icon(Icons.add), label: "Secondary refresh example 1"),
                  BottomNavigationBarItem(icon: Icon(Icons.border_clear), label: "Secondary refresh example 2")
                ],
              )
            : null,
        body: Stack(
